...
class LightView {
    ...
    draw() {
        ...
        this.gl.uniform3fv(this.clr1, this.green);
        this.gl.uniform3fv(this.clr2, this.green);
        this.gl.drawArrays(this.gl.TRIANGLE_STRIP, 0, this.resCircle * 2 + 2);

        var mv = GetModelViewMatrix(0, 0, this.posZ, this.rotX, this.rotY, this.rotZ,0);
        var mvp = MatrixMult(this.proj, mv);
        this.gl.uniformMatrix4fv(this.mvp, false, mvp);
        this.gl.uniform3fv(this.clr1, this.orange);
        this.gl.uniform3fv(this.clr2, this.orange);

        this.gl.drawArrays(this.gl.TRIANGLE_STRIP, 0, this.resCircle * 2 + 2);
        this.gl.drawArrays(this.gl.TRIANGLE_STRIP, this.resCircle * 2 + 2, this.resCircle * 2 + 2);

        this.gl.uniform3fv(this.clr1, this.gold);
        this.gl.uniform3fv(this.clr2, this.black);
